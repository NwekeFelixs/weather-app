...
export const updateWeather = function(lat, lon) {
    ...
    fetchData(url.currentWeather(lon, lat), function(currentWeather){
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                windLi.innerHTML = `
                    ...
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/direction.png" alt="direction" class="weather-icon" width="48" height="48" loading="lazy" title="direction" style="transform: rotate(${windDirection - 180}deg)">
